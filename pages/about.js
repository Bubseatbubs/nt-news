  ...
  return (
    <Layout>
      ...
      <section class={`${styles.card}`}>
        <div className={`${styles.showDesc} ${utilStyles.center}`}>Jeebub Wilson</div> 
      ...
      {/* Billy Busso */}
      <section class={`${styles.card}`}>
        <div className={`${styles.showDesc} ${utilStyles.center}`}>Billo Busso</div> 
      ...
      {/* Bittel Battel */}
      <section class={`${styles.card}`}>
        <div className={`${styles.showDesc} ${utilStyles.center}`}>Bittel Battel</div> 
      ...
      {/* Boilin Vetcheiz */}
      <section class={`${styles.card}`}>
        <div className={`${styles.showDesc} ${utilStyles.center}`}>Boilin Vetchiez</div> 
      ...
      {/* Weet Buz */}
      <section class={`${styles.card}`}>
        <div className={`${styles.showDesc} ${utilStyles.center}`}>Weet Buz</div> 
      ...
      {/* Jain Ethos */}
      <section class={`${styles.card}`}>
        <div className={`${styles.showDesc} ${utilStyles.center}`}>Jain Ethos</div> 
